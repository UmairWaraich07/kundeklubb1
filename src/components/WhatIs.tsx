...
const WhatIs = () => {
  return (
    <section className="w-full pt-32 max-lg:pt-24 max-sm:pt-20 pb-16 max-sm:pb-10">
      ...
      <div className=" mt-16 max-sm:mt-10 w-full grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 justify-center items-start ">
        ...
        <div className="space-y-4 lg:hidden max-sm:hidden ">
          <div className=" max-sm:hidden px-4 py-8 space-y-3 rounded-lg border border-primary-400/40 hover:border-primary-600 bg-[#F6FAFF4D] cursor-pointer shadow-sm">
        ...
        <div className="  max-lg:hidden px-4 py-8 space-y-3 rounded-lg border border-primary-400/40 hover:border-primary-600 bg-[#F6FAFF4D] cursor-pointer shadow-sm">
          <h4 className="text-left font-bold max-md:text-base text-lg text-dark ">
            Effortless Customer Retention
          </h4>
          <p className="text-base text-secondary-600 ">
        ...
        <Accordion
          className="sm:hidden px-4 rounded-lg border border-primary-400/40 hover:border-primary-600 bg-[#F6FAFF4D] cursor-pointer shadow-sm"
          type="single"
          collapsible
        >
          <AccordionItem value="item-1">
            <AccordionTrigger className="font-semibold max-md:text-base text-lg text-dark">
              Effortless Customer Retention
            </AccordionTrigger>
            <AccordionContent>
              A loyalty program makes it so much easier to get customers back to
        ...
        >
          <AccordionItem value="item-1">
            ...
            <AccordionContent>
              With Kundeklubb1 you can easily analyze your customers’ interests
        ...
        >
          <AccordionItem value="item-1">
            ...
            <AccordionContent>
               With Kudeklubb1, you OWN a direct marketing channel and all
              customer data. This means you can spend less on expensive
              marketing and be more profitable.
            </AccordionContent>
          </AccordionItem>
        </Accordion>
        <Accordion
        ...
        >
          <AccordionItem value="item-1">
            ...
            <AccordionContent>
              Kundeklubb1 members automatically give their TCPA and GDPR
              approved consent, which means that you can communicate directly
              with them in your own marketing channel.
            </AccordionContent>
          </AccordionItem>
        </Accordion>
        <Accordion
        ...
        >
          <AccordionItem value="item-1">
            ...
            <AccordionContent>
              This means that you can run targeted, personalized campaigns to
              make your customers more loyal - also when they&apos;re not in
              your store.
            </AccordionContent>
          </AccordionItem>
        </Accordion>
